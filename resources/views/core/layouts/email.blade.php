...
<html>
    <head>
        <title>The {{ config('app.name', 'vTual') }} Mailer</title>
    </head>
    <body>
        ...
        <hr />
        <p><strong><small>*This email is sent automatically and is not monitored. You will not receive a response if you reply to this email.</small></strong></p>
